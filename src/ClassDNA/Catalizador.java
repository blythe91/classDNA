...
//        
    ...
    public boolean exec(){
        try {
            ...
            if (this.tipo.compareTo("EI")==0) {
                carpeta = new File(this.tipo+"_GT/2Datos Formato Arff EI/Resultados/DataEI.arff");
